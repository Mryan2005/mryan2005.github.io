<% if (theme.site_footer) { %>
  ...
  <footer class="footer clearfix"  itemscope itemtype="http://schema.org/WPFooter">
    ...
    <script id="LA-DATA-WIDGET" crossorigin="anonymous" charset="UTF-8" src="https://v6-widget.51.la/v6/3IYBQYUAzjNo7bqN/quote.js?theme=0&col=true&f=12&badge=icon_0&icon=center"></script>
